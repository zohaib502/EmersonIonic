...
@IonicPage()
@Component({
  selector: 'solution-device-type-ae',
  templateUrl: 'solution-device-type-ae.html',
})

export class DeviceTypeAeSolution {
  Enums: any = Enums;
  fileName: any = 'DeviceTypeAeSolution';
  header_data: any;
  ...
  ionViewDidEnter() {
    ...
    // }, 400);
    // let promiseArr = [];
    // promiseArr.push(this.getAsFoundActuation());
    // promiseArr.push(this.getAsLeftActuation());
    // promiseArr.push(this.getRecActionActuation());
