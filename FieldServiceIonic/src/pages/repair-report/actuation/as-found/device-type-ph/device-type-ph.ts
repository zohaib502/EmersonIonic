...
@IonicPage()
@Component({
  selector: 'page-device-type-ph',
  templateUrl: 'device-type-ph.html',
})
export class DeviceTypePhPage {
  fileName: any = 'DeviceTypePhPage';
  header_data: any;
  ...
  */
  ...
  setJson() {
    let json = {
      ...
      "SpurGear": this.asFoundObj.G_SPURGEAR_NA,
