...
@IonicPage()
@Component({
  selector: 'page-user-preferences-modal',
  templateUrl: 'user-preferences-modal.html',
})
export class UserPreferencesModalPage {
  /**
 ...
 */
  ...
  constructor(public navCtrl: NavController, private localService: LocalServiceProvider, public logger: LoggerProvider, public viewCtrl: ViewController, public navParams: NavParams, public valueService: ValueProvider, public utilityProvider: UtilityProvider, public events: Events) {
  }
